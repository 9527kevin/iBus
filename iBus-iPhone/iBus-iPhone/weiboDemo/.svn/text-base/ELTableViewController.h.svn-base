...
typedef NSInteger (^numberOfRowsInSectionDelegate) (UITableView *, NSInteger section);
...
@interface ELTableViewController : BaseController
<
UITableViewDelegate,
...
@property (nonatomic,copy) numberOfRowsInSectionDelegate numberOfRowsInSectionDelegate;
