...
#define Frequency_TextView_Origin_X Frequency_Label_Origin_X + Frequency_Label_Width + 5.0f
#define Frequency_TextView_Origin_Y Frequency_Label_Origin_Y + 2.0f
#define Frequency_TextView_Width Unit_Label_Origin_X - (Frequency_TextView_Origin_X) - 5.0f
...
#define Tip_ImgView_Origin_Y Frequency_Label_Origin_Y + Frequency_Label_Height +3.0f
...
#define Tip_Label_Origin_X (Tip_ImgView_Origin_X) + Tip_ImgView_Width + 2.0f
