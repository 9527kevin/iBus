...
((Dynamic_State_ContainerView_Height - (Station_Label_Height * 8)) / 9)

#define Station_Label_Origin_X              5.0f
#define Station_Label_Width                                                 \
(MainWidth * 0.5 -20.0f - Station_Label_Origin_X)
...
#define StationEntryMark_ImageView_Origin_X                                 \
Arrow_ImageView_Origin_X + Arrow_ImageView_Width
